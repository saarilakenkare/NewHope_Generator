...
class KeyEncaps extends Module {
  ...
  val poly_e_prime = RegInit(Vec(Seq.fill(512)(0.U(16.W))))
  val poly_v_prime = RegInit(Vec(Seq.fill(512)(0.U(16.W))))
